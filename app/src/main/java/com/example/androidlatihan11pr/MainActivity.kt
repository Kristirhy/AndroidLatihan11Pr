package com.example.androidlatihan11pr
...
import com.example.androidlatihan11pr.adapter.MovieAdapter
import com.example.androidlatihan11pr.model.Movie
import com.example.androidlatihan11pr.model.MovieResponse
import com.example.androidlatihan11pr.service.ApiClient
import com.example.androidlatihan11pr.service.ApiInterface
        ...
        call.enqueue(object : Callback<Movie> {
            ...
            override fun onResponse(call: Call<Movie>?, response: Response<Movie>?) {
                if (response != null) {
                    ...
                    if (posterPath == null) {
                        collapseImage.setImageResource(R.drawable.ic_launcher_foreground)
                    } else {
